...
export function normalizeSettings(input: Partial<AppSettings> | unknown): AppSettings {
  ...
  return {
    ...
    clearInputImagesAfterSubmit: typeof record.clearInputImagesAfterSubmit === 'boolean' ? record.clearInputImagesAfterSubmit : false,
...
export const DEFAULT_SETTINGS: AppSettings = normalizeSettings({
  ...
  clearInputImagesAfterSubmit: false,
